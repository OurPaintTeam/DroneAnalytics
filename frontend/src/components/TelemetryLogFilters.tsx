            ...
            <div className="grid gap-2.5 md:grid-cols-12 md:items-end md:gap-x-3">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:col-span-6">
                    <label className="flex flex-col gap-1">
                        <span className="text-[10px] font-semibold uppercase tracking-[0.08em] text-slate-500">Тип дрона</span>
                        <select
                            id={`${baseId}-drone`}
                    ...
                    <label className="flex flex-col gap-1">
                        <span className="text-[10px] font-semibold uppercase tracking-[0.08em] text-slate-500">ID дрона</span>
                        <input
                            id={`${baseId}-did`}
                            type="text"
                            inputMode="numeric"

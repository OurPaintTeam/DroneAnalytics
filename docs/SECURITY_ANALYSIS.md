...
| ----------------------- | --------------- | --------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A1 Телеметрия           | Средний         | **Критический** | Высокий         | Подмена координат искажает журнал и мешает расследованию. Потеря данных мешает расследованию инцидентов. Потеря координат даёт возможность атаки (неопределённость координат для анализа). |
